<x-app-layout>
    <div class="container pt-5">
        ...
        <div class="text-end pb-2">
            <a href="{{ route('coupons.create')}}" class="btn btn-success" style="background-color: #13B807; border: none;">
                ...
                <tr>
                    ...
                    <td class="">
                        <div class="flex justify-end">
                            <a href="{{ route('coupons.edit', $coupon->id)}}" class="btn btn-success" style="background-color: #2019FF; border: none;">
