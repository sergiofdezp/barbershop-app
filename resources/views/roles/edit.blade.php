            ...
            <div class="row mb-4">
                <div>
                    <div class="border rounded p-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-sm" value="{{$role->name}}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div>
                    <div class="border rounded p-3">
                        ...
                        <p class="text-muted text-sm">Edita los permisos de este rol.</p>
