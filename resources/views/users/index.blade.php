                ...
                <tr>
                    ...
                    <td class="">
                        <div class="flex justify-end">
                            <a href="{{ route('users.edit', $user->id)}}" class="btn btn-success" style="background-color: #2019FF; border: none;">
                            ...
                            <form action="{{ route('users.destroy', $user->id)}}" class="formEliminar px-1" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" style="background-color: #B9314F; border: none;">
