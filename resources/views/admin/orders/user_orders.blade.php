                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card service-hover d-flex align-items-center text-center rounded h-100 mb-0">
                            <div class="card-body  d-flex flex-column justify-content-center align-items-center">
                                ...
                                <p class="card-text text-muted text-sm">¡Crea tu nueva reserva!</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row px-5 pb-3">
                                            @for ($i = 0; $i < $max_services; $i++)
                                                <div class="d-flex justify-content-center col-3 p-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="{{ $i < $card->num_services ? 'currentColor' : '#E8E8E8' }}" class="bi bi-scissors" viewBox="0 0 16 16">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text m-0">Fecha: {{$order->order_date}} | {{$order->order_hour}}h.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
