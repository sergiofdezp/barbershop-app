<x-app-layout>
    <div class="container pt-5">
        ...
        <div class="text-end pb-2">
            <a href="{{ route('orders.create')}}" class="btn btn-success" style="background-color: #13B807; border: none;">
                ...
                <tr>
                    ...
                    <td class="">
                        <div class="flex justify-end">
                            <a href="{{ route('orders.show', $order->id)}}" class="btn btn-dark btn-sm mx-1" style="background-color: #33BEFF; border: none;">
